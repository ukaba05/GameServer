...
{isConditionTrue_0 = (gdjs.evtsExt__ArrayTools__IndexOf.func(runtimeScene, runtimeScene.getScene().getVariables().get("__ArrayTools").getChild("Temp"), eventsFunctionContext.getArgument("Value"), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) != -(1));
}
